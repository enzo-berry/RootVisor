...
typedef union _IA32_VMX_EPT_VPID_CAP_REGISTER
{
    ...
    {
        /**
         * [Bit 0] When set to 1, the processor supports execute-only translations by EPT. This support allows software
         * to configure EPT paging-structure entries in which bits 1:0 are clear (indicating that data accesses are not
        ...
        /**
         * [Bit 8] When set to 1, the logical processor allows software to configure the EPT paging-structure memory
         * type to be uncacheable (UC).
         *
        ...
        /**
         * [Bit 14] When set to 1, the logical processor allows software to configure the EPT paging-structure memory
         * type to be write-back (WB).
         */
        UINT64 MemoryTypeWriteBack : 1;
        UINT64 Reserved4           : 1;

        /**
         * [Bit 16] When set to 1, the logical processor allows software to configure a EPT PDE to map a 2-Mbyte page
         * (by setting bit 7 in the EPT PDE).
         */
        UINT64 Pde2MbPages : 1;

        /**
         * [Bit 17] When set to 1, the logical processor allows software to configure a EPT PDPTE to map a 1-Gbyte page
         * (by setting bit 7 in the EPT PDPTE).
         */
        ...
        /**
         * [Bit 22] When set to 1, the processor reports advanced VM-exit information for EPT violations. This reporting
...
typedef union _PEPT_PML4
{
    struct
    {
        ...
        /**
         * [Bit 1] Write access; indicates whether writes are allowed from the 512-GByte region controlled by this
         * entry.
         */
        UINT64 WriteAccess : 1;

        /**
         * [Bit 2] If the "mode-based execute control for EPT" VM-execution control is 0, execute access; indicates
         * whether instruction fetches are allowed from the 512-GByte region controlled by this entry. If that control
         * is 1, execute access for supervisor-mode linear addresses; indicates whether instruction fetches are allowed
         * from supervisor-mode linear addresses in the 512-GByte region controlled by this entry.
         */
        UINT64 ExecuteAccess : 1;
        UINT64 Reserved1     : 5;

        /**
         * [Bit 8] If bit 6 of EPTP is 1, accessed flag for EPT; indicates whether software has accessed the 512-GByte
         * region controlled by this entry. Ignored if bit 6 of EPTP is 0.
         *
         * @see Vol3C[28.2.4(Accessed and Dirty Flags for EPT)]
         */
        UINT64 Accessed  : 1;
        ...
        /**
         * [Bit 10] Execute access for user-mode linear addresses. If the "mode-based execute control for EPT"
         * VM-execution control is 1, indicates whether instruction fetches are allowed from user-mode linear addresses
         * in the 512-GByte region controlled by this entry. If that control is 0, this bit is ignored.
         */
...
typedef union _EPDPTE_1GB
{
    struct
    {
        ...
        /**
         * [Bit 2] If the "mode-based execute control for EPT" VM-execution control is 0, execute access; indicates
         * whether instruction fetches are allowed from the 1-GByte page controlled by this entry. If that control is 1,
         * execute access for supervisor-mode linear addresses; indicates whether instruction fetches are allowed from
         * supervisor-mode linear addresses in the 1-GByte page controlled by this entry.
         */
        UINT64 ExecuteAccess : 1;
        ...
        /**
         * [Bit 8] If bit 6 of EPTP is 1, accessed flag for EPT; indicates whether software has accessed the 1-GByte
         * page referenced by this entry. Ignored if bit 6 of EPTP is 0.
         *
         * @see Vol3C[28.2.4(Accessed and Dirty Flags for EPT)]
         */
        UINT64 Accessed : 1;
        ...
        /**
         * [Bit 9] If bit 6 of EPTP is 1, dirty flag for EPT; indicates whether software has written to the 1-GByte page
         ...
         * [Bit 10] Execute access for user-mode linear addresses. If the "mode-based execute control for EPT"
         * VM-execution control is 1, indicates whether instruction fetches are allowed from user-mode linear addresses
         * in the 1-GByte page controlled by this entry. If that control is 0, this bit is ignored.
         */
        UINT64 UserModeExecute : 1;
        UINT64 Reserved1       : 19;
        ...
        /**
         * [Bit 63] Suppress \#VE. If the "EPT-violation \#VE" VM-execution control is 1, EPT violations caused by
         * accesses to this page are convertible to virtualization exceptions only if this bit is 0. If "EPT-violation
         * \#VE" VMexecution control is 0, this bit is ignored.
         *
...
typedef union _EPDPTE
{
    struct
    {
        ...
        /**
         * [Bit 2] If the "mode-based execute control for EPT" VM-execution control is 0, execute access; indicates
         * whether instruction fetches are allowed from the 1-GByte region controlled by this entry. If that control is
         * 1, execute access for supervisor-mode linear addresses; indicates whether instruction fetches are allowed
         * from supervisor-mode linear addresses in the 1-GByte region controlled by this entry.
         */
        UINT64 ExecuteAccess : 1;
        UINT64 Reserved1     : 5;
         ...
         * [Bit 10] Execute access for user-mode linear addresses. If the "mode-based execute control for EPT"
         * VM-execution control is 1, indicates whether instruction fetches are allowed from user-mode linear addresses
         * in the 1-GByte region controlled by this entry. If that control is 0, this bit is ignored.
         */
        UINT64 UserModeExecute : 1;
        UINT64 Reserved3       : 1;
...
typedef union _EPDE_2MB
{
    struct
    {
        ...
        /**
         * [Bit 2] If the "mode-based execute control for EPT" VM-execution control is 0, execute access; indicates
         * whether instruction fetches are allowed from the 2-MByte page controlled by this entry. If that control is 1,
         * execute access for supervisor-mode linear addresses; indicates whether instruction fetches are allowed from
         * supervisor-mode linear addresses in the 2-MByte page controlled by this entry.
         */
        UINT64 ExecuteAccess : 1;
        ...
        /**
         * [Bit 8] If bit 6 of EPTP is 1, accessed flag for EPT; indicates whether software has accessed the 2-MByte
         * page referenced by this entry. Ignored if bit 6 of EPTP is 0.
         *
         * @see Vol3C[28.2.4(Accessed and Dirty Flags for EPT)]
         */
        ...
        /**
         * [Bit 9] If bit 6 of EPTP is 1, dirty flag for EPT; indicates whether software has written to the 2-MByte page
         * referenced by this entry. Ignored if bit 6 of EPTP is 0.
         *
         * @see Vol3C[28.2.4(Accessed and Dirty Flags for EPT)]
         */
         ...
         * [Bit 10] Execute access for user-mode linear addresses. If the "mode-based execute control for EPT"
         * VM-execution control is 1, indicates whether instruction fetches are allowed from user-mode linear addresses
         * in the 2-MByte page controlled by this entry. If that control is 0, this bit is ignored.
         */
        UINT64 UserModeExecute : 1;
        UINT64 Reserved1       : 10;
...
typedef union _EPDE
{
    struct
    {
        ...
        /**
         * [Bit 2] If the "mode-based execute control for EPT" VM-execution control is 0, execute access; indicates
         * whether instruction fetches are allowed from the 2-MByte region controlled by this entry. If that control is
         * 1, execute access for supervisor-mode linear addresses; indicates whether instruction fetches are allowed
         * from supervisor-mode linear addresses in the 2-MByte region controlled by this entry.
         */
        UINT64 ExecuteAccess : 1;
        UINT64 Reserved1     : 5;
         ...
         * [Bit 10] Execute access for user-mode linear addresses. If the "mode-based execute control for EPT"
         * VM-execution control is 1, indicates whether instruction fetches are allowed from user-mode linear addresses
         * in the 2-MByte region controlled by this entry. If that control is 0, this bit is ignored.
         */
        UINT64 UserModeExecute : 1;
        UINT64 Reserved3       : 1;
...
typedef union _EPTE
{
    struct
    {
        ...
        /**
         * [Bit 2] If the "mode-based execute control for EPT" VM-execution control is 0, execute access; indicates
         * whether instruction fetches are allowed from the 4-KByte page controlled by this entry. If that control is 1,
         * execute access for supervisor-mode linear addresses; indicates whether instruction fetches are allowed from
         * supervisor-mode linear addresses in the 4-KByte page controlled by this entry.
         */
        UINT64 ExecuteAccess : 1;
        ...
        /**
         * [Bit 8] If bit 6 of EPTP is 1, accessed flag for EPT; indicates whether software has accessed the 4-KByte
         * page referenced by this entry. Ignored if bit 6 of EPTP is 0.
         *
         * @see Vol3C[28.2.4(Accessed and Dirty Flags for EPT)]
         */
        ...
        /**
         * [Bit 9] If bit 6 of EPTP is 1, dirty flag for EPT; indicates whether software has written to the 4-KByte page
         * referenced by this entry. Ignored if bit 6 of EPTP is 0.
         *
         * @see Vol3C[28.2.4(Accessed and Dirty Flags for EPT)]
         */
         ...
         * [Bit 10] Execute access for user-mode linear addresses. If the "mode-based execute control for EPT"
         * VM-execution control is 1, indicates whether instruction fetches are allowed from user-mode linear addresses
         * in the 4-KByte page controlled by this entry. If that control is 0, this bit is ignored.
         */
        UINT64 UserModeExecute : 1;
        UINT64 Reserved2       : 1;
...
typedef struct _VMM_EPT_PAGE_TABLE
{
     ...
     * NOTE: We are using 2MB pages as the smallest paging size in our map, so we do not manage individiual 4096 byte
     * pages. Therefore, we do not allocate any PML1 (4096 byte) paging structures.
     */
...
typedef union _IA32_MTRR_CAPABILITIES_REGISTER
{
    struct
    {
         ...
         *
         * [Bit 8] Fixed range MTRRs (MSR_IA32_MTRR_FIX64K_00000 through MSR_IA32_MTRR_FIX4K_0F8000) are supported when
         * set; no fixed range registers are supported when clear.
         */
         ...
         *
         * [Bit 11] The system-management range register (SMRR) interface is supported when bit 11 is set; the SMRR
         * interface is not supported when clear.
         */
...
typedef union _IA32_MTRR_PHYSBASE_REGISTER
{
    struct
    {
        ...
        /**
         * [Bits 47:12] Specifies the base address of the address range. This 24-bit value, in the case where MAXPHYADDR
         * is 36 bits, is extended by 12 bits at the low end to form the base address (this automatically aligns the
...
typedef union _IA32_MTRR_PHYSMASK_REGISTER
{
    struct
    {
        ...
        /**
         * [Bits 47:12] Specifies a mask (24 bits if the maximum physical address size is 36 bits, 28 bits if the
         * maximum physical address size is 40 bits). The mask determines the range of the region being mapped,
         ...
         * CPUID.80000008H reports the maximum physical address size supported by the processor. If CPUID.80000008H is
         * not available, software may assume that the processor supports a 36-bit physical address size.
         *
...
typedef union _VMX_EXIT_QUALIFICATION_EPT_VIOLATION
{
    struct
    {
        ...
        /**
         * [Bit 3] The logical-AND of bit 0 in the EPT paging-structure entries used to translate the guest-physical
         * address of the access causing the EPT violation (indicates whether the guest-physical address was readable).
         */
        UINT64 EptReadable : 1;

        /**
         * [Bit 4] The logical-AND of bit 1 in the EPT paging-structure entries used to translate the guest-physical
         * address of the access causing the EPT violation (indicates whether the guest-physical address was writeable).
         */
        UINT64 EptWriteable : 1;

        /**
         * [Bit 5] The logical-AND of bit 2 in the EPT paging-structure entries used to translate the guest-physical
         * address of the access causing the EPT violation. If the "mode-based execute control for EPT" VM-execution
         * control is 0, this indicates whether the guest-physical address was executable. If that control is 1, this
         * indicates whether the guest-physical address was executable for supervisor-mode linear addresses.
         */
        UINT64 EptExecutable : 1;

        /**
         * [Bit 6] If the "mode-based execute control" VM-execution control is 0, the value of this bit is undefined. If
         * that control is 1, this bit is the logical-AND of bit 10 in the EPT paging-structures entries used to
         * translate the guest-physical address of the access causing the EPT violation. In this case, it indicates
         * whether the guest-physical address was executable for user-mode linear addresses.
         */
        UINT64 EptExecutableForUserMode : 1;

        /**
         * [Bit 7] Set if the guest linear-address field is valid. The guest linear-address field is valid for all EPT
         * violations except those resulting from an attempt to load the guest PDPTEs as part of the execution of the
         * MOV CR instruction.
         */
        ...
        /**
         * [Bit 8] If bit 7 is 1:
         * - Set if the access causing the EPT violation is to a guest-physical address that is the translation of a
         * linear address.
         * - Clear if the access causing the EPT violation is to a paging-structure entry as part of a page walk or the
         * update of an accessed or dirty bit. Reserved if bit 7 is 0 (cleared to 0).
         */
        UINT64 CausedByTranslation : 1;

        /**
         * [Bit 9] This bit is 0 if the linear address is a supervisor-mode linear address and 1 if it is a user-mode
         * linear address. Otherwise, this bit is undefined.
         *
         * @remarks If bit 7 is 1, bit 8 is 1, and the processor supports advanced VM-exit information for EPT
         * violations. (If CR0.PG = 0, the translation of every linear address is a user-mode linear address and thus
         * this bit will be 1.)
         */
        UINT64 UserModeLinearAddress : 1;

        /**
         * [Bit 10] This bit is 0 if paging translates the linear address to a read-only page and 1 if it translates to
         * a read/write page. Otherwise, this bit is undefined
         *
         * @remarks If bit 7 is 1, bit 8 is 1, and the processor supports advanced VM-exit information for EPT
         * violations. (If CR0.PG = 0, every linear address is read/write and thus this bit will be 1.)
         */
        UINT64 ReadableWritablePage : 1;

        /**
         * [Bit 11] This bit is 0 if paging translates the linear address to an executable page and 1 if it translates
         * to an execute-disable page. Otherwise, this bit is undefined.
         *
         * @remarks If bit 7 is 1, bit 8 is 1, and the processor supports advanced VM-exit information for EPT
         * violations. (If CR0.PG = 0, CR4.PAE = 0, or MSR_IA32_EFER.NXE = 0, every linear address is executable and
         * thus this bit will be 0.)
         */
...
BOOLEAN
EptVmxRootModePageHook(PVOID TargetFunc, BOOLEAN HasLaunched);
// Hook in VMX Non Root Mode
BOOLEAN
EptPageHook(PVOID TargetFunc, BOOLEAN HasLaunched);
